...
const getAllProducts = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const respuesta = yield fetch('https://dummyjson.com/products');
...
function filtrarPorTitulo(productos, titulo) {
    return productos.filter(producto => producto.title.toLowerCase().includes(titulo.toLowerCase()));
}
function buscarProducto() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            inputBusqueda.addEventListener('input', () => __awaiter(this, void 0, void 0, function* () {
                const texto = inputBusqueda.value;
                const respuesta = yield fetch(`https://dummyjson.com/products/search?q=${texto}`);
                console.log(respuesta);
                const datos = yield respuesta.json();
...
const getAllCategories = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const respuesta = yield fetch('https://dummyjson.com/products/category-list');
        const categorias = yield respuesta.json();
...
function agregarAlCarrito(userId, productos) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
